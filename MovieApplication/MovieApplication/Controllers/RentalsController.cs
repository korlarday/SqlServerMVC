...
namespace MovieApplication.Controllers
{
    public class RentalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CustomerId,MovieId,Date")] Rental rental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CustomerId,MovieId,Date")] Rental rental)
        {
            if (ModelState.IsValid)
            {
